...
void dfs(int v, int p, int keep) {
    ...
    for (auto u : g[v]) {
        ...
        add(v, p, 1); // Now we have the information of subtree of v
        computeans(v);
...
// Sample Solution 2 (Offline Processing):
// https://codeforces.com/contest/570/submission/40034531
...
// Sasmple Solution 4:
// https://codeforces.com/contest/375/submission/40044165
